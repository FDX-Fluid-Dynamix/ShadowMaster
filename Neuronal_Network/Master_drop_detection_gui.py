...
if gui==True:
    ...
    folder, folder_result, n_calib, n_visual, scale,n_pic, Visual, n_pic_all, image_type, bg_sub, files_bg, detection_min_score, range_hist,bins_hist=gui_shadow.GUI_Shadowgraphy()
