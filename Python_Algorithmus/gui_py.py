...
#%%     SCALE
        ...
        self.text_scale.setGeometry(QtCore.QRect(30, y_s, 300, 22))
        ...
        self.spinBox_scale.setGeometry(QtCore.QRect(390, y_s, 42, 22))
        ...
        self.label_scale.setGeometry(QtCore.QRect(460, y_s, 381, 16))
...
#%%         VISUALISIERUNG
        ...
        self.checkBox_vis.setText( "Save images?")
...
#    bins_hist=200
    ...
    return folder, folder_ausw, n_pic_all, n_pic, subtract_bg , n_sbg, scale, Visual, n_vis  #,  n_calib, n_vis, scale,n_pic, Visual,  , image_type,  detection_min_score , range_hist, bins_hist
