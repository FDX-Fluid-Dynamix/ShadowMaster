...
In the following picture all steps are shown in an example image.
...
For humans, an object appears sharp if there is a large colour difference between the edgevalue and the close environment.
...
A new approach to the analysis of Shadwowgraphy images represents a neural network.
